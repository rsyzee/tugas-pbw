...
$sql2 = "SELECT * FROM article WHERE gambar != ''";
	...
	<div class="mt-8">
		...
		<div class="flex flex-wrap gap-4">
			<a href="admin.php?page=article" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-lg transition-colors flex items-center gap-2">
				<i class="bi bi-plus-circle"></i> Manage Articles
			</a>
			<a href="admin.php?page=dashboard" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-3 px-6 rounded-lg transition-colors flex items-center gap-2">
